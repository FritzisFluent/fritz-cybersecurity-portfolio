        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            <div className="space-y-4 text-cyber-light/80">
              <p>
                I'm a U.S.-based Cybersecurity Analyst and Technology Consultant with over 4 years 
            ...
            <div className="mt-8">
              <h3 className="text-xl font-bold mb-4 text-cyber-primary">Current Focus</h3>
          ...
          <div className="cyber-card flex items-center justify-center">
            <div className="text-center">
              <div className="text-6xl font-bold text-cyber-primary mb-3">4+</div>
              <p className="text-cyber-light/70 text-lg">Years of Experience</p>
              
              <div className="border-t border-cyber-primary/20 my-6"></div>
              
              <div className="text-6xl font-bold text-cyber-primary mb-3">5</div>
              <p className="text-cyber-light/70 text-lg">Languages</p>
              
              <div className="border-t border-cyber-primary/20 my-6"></div>
              
              <div className="text-cyber-primary font-mono">
                <div>$whoami</div>
                <div className="text-cyber-light mt-2">cybersecurity_professional</div>
              </div>
            </div>
          </div>
        </div>
